...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adj = JOptionPane.showInputDialog(null, "Type an adjective");

		// Get the user to enter a type of liquid
		String liquid = JOptionPane.showInputDialog(null, "Type a type of liquid");
		...
		String place = JOptionPane.showInputDialog(null, "Type a place");
